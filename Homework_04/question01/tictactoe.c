 ...
 * Extended by: Kevin Kerliu and Rebecca Gartenberg
 */
 ...
 * If/tmp/ccbYRTRh.o:tictactoe.c:(.text+0x82f): undefined reference to `draw_board' a winning square exists, return the square;
 * otherwise, return 0.
 */
int find_win(char symbol)
{
   ...
   * After the play_tourname loop, if one or more wins have been found,
